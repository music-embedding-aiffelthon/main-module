...
if __name__ == "__main__":
    ...
    data = mel_dataset(dataset_dir, 1)
    ...
    for k in range(0,30):
        ...
        train_dataloader = DataLoader(train_dataset, batch_size=batch_size,shuffle=True, num_workers=0, collate_fn=collate_batch)
        test_dataloader = DataLoader(test_dataset, batch_size=int(batch_size/4), shuffle=True, num_workers=0)
        ...
        checkpoints.save_checkpoint(ckpt_dir=config['checkpoints_path'], target=state.params,  prefix='genre0', step=state.step)  
